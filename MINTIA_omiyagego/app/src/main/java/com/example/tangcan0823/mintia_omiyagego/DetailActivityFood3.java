 ...
 */
public class DetailActivityFood3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        collapsingToolbar.setTitle("キャラメルプリン");

        ImageView ivImage = (ImageView)findViewById(R.id.ivImage);
        ivImage.setImageResource(R.drawable.food3);
    ...
    private void setupViewPager(ViewPager mViewPager) {
        ...
        adapter.addFragment(DetailFragment.newInstance(getAsset("food_infoData/food_info002txt")), "詳細");
