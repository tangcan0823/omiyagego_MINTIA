 ...
 */
public class DetailActivityFood2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivImage.setImageResource(R.drawable.food2);
    ...
    private void setupViewPager(ViewPager mViewPager) {
        ...
        adapter.addFragment(DetailFragment.newInstance(getAsset("food_infoData/food_info001txt")), "詳細");
