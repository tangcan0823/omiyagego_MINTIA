...
public class Activity_k5 extends DetailActivity {
    private String goods_id = "kougeihin05_comment_object";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivImage.setImageResource(R.drawable.kougeihin_pic05);
    ...
    public void setupViewPager(ViewPager mViewPager) {
        ...
        adapter.addFragment(DetailFragment.newInstance(getAsset("kougeihin_introData/kougeihin_intro05.txt")), "紹介");
        adapter.addFragment(DetailRoadFragment.newInstance("", "" + (String) getText(R.string.kougeihin_search_5)), "地図");
        adapter.addFragment(DetailFragment.newInstance(getAsset("kougeihin_infoData/kougeihin_info05.txt")), "詳細");
